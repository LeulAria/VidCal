...
import TextComponent from "components/util/TextComponent";
  ...
  return (
    <div className="h-screen w-screen flex items-center justify-center bg-black text-white">
      ...
      <main className="z-10 ml-[30%]">
        ...
        <h1 className="font-[900] text-8xl">34+ Online</h1>
        <h1 className="ml-2 max-w-[500px] font-[700] text-2xl">
          Join by filling the form below...
        </h1>
        <div className="mt-5 flex w-[430px]">
          <div className="">
            ...
            <ThemeProvider theme={{
              ...
              <FormControl sx={{ m: 1, minWidth: 80, color: "#d8cdcd" }}>
                <InputLabel
                ...
                >
                  ...
                  <MenuItem value={22}>Don't Mention</MenuItem>
                </Select>
              </FormControl>
            </ThemeProvider>
          </div>
